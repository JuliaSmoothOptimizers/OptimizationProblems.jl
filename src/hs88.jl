# Hock and Schittkowski problem number 88.
#
#   Source:
#   Problem 88 in
...
function h2(x1,x2)
  x = [x1,x2]
  dh2(s) = sum(α2(s,j)*ρ2(x,j) - k2(s) for j = 1:30)
  return quadgk(dh2, 0, 1)
end
...
function hs88(args...)
  ...
  ϵ = 0.01
  JuMP.register(nlp, :h2, n, h2, autodiff=true)
  @NLconstraint(nlp, ϵ^2 - h2(x[1],x[2]) >= 0)
