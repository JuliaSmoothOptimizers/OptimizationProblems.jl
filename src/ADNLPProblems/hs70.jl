...
function hs70(; n::Int = default_nvar, type::Val{T} = Val(Float64), kwargs...) where {T}
  ...
  yobs[1:10] = [189 // 100000, 1038 // 10000, 268 // 1000, 506 // 1000, 577 // 1000, 604 // 1000, 725 // 1000, 898 // 1000, 947 // 1000, 845 // 1000]
  yobs[11:19] = [702 // 1000, 528 // 1000, 385 // 1000, 257 // 1000, 159 // 1000, 869 // 10000, 453 // 10000, 1509 // 100000, 189 // 100000]
  function f(x)
    n = length(x)
    b = x[3] + (1 - x[3]) * x[4]
    ycal = [
