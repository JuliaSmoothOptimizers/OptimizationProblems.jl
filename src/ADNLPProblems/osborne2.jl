...
function osborne2(::Val{:nlp}; n::Int = default_nvar, type::Type{T} = Float64, kwargs...) where {T}
  y = [
    1366 // 1000,
    1191 // 1000,
    1112 // 1000,
...
function osborne2(::Val{:nls}; n::Int = default_nvar, type::Type{T} = Float64, kwargs...) where {T}
  y = [
    1366 // 1000,
    1191 // 1000,
    1112 // 1000,
