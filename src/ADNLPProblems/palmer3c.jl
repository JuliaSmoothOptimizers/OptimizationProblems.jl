...
function palmer3c(::Val{:nlp}; n::Int = default_nvar, type::Val{T} = Val(Float64), kwargs...) where {T}
  X = [
    -1.658063,
    -1.570796,
    -1.396263,
...
function palmer3c(::Val{:nls}; n::Int = default_nvar, type::Val{T} = Val(Float64), kwargs...) where {T}
  X = [
    -1.658063,
    -1.570796,
    -1.396263,
