...
function palmer2c(::Val{:nlp}; n::Int = default_nvar, type::Type{T} = Float64, kwargs...) where {T}
  X = [
    -1.745329,
    -1.570796,
    -1.396263,
...
function palmer2c(::Val{:nls}; n::Int = default_nvar, type::Type{T} = Float64, kwargs...) where {T}
  X = [
    -1.745329,
    -1.570796,
    -1.396263,
