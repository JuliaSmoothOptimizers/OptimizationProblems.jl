...
function hs114(args...)
  ...
  @NLexpression(nlp, g1, 35.82 - 0.222*x[10] - b*x[9])
  @NLexpression(nlp, g2, -133 + 3*x[7] - a*x[10])
  ...
  @NLconstraint(nlp, g1 >= 0)
  @NLconstraint(nlp, g2 >= 0)
  @NLconstraint(nlp, -g1 + x[9]*(1/b - b) >= 0)
  @NLconstraint(nlp, -g2 + (1/a - a)*x[10] >= 0)
  @NLconstraint(nlp, g5 >= 0)
  @NLconstraint(nlp, g6 >= 0)
  @NLconstraint(nlp, -g5 + (1/a - a)*x[4] >= 0)
  @NLconstraint(nlp, -g6 + (1/a - a)*x[7] >= 0)
  @NLconstraint(nlp, 1.22*x[4] - x[1] - x[5] == 0)
