...
get_dqrtic_nvar(; n::Int = default_nvar, kwargs...) = 1 * n + 0
get_dqrtic_ncon(; n::Int = default_nvar, kwargs...) = 0
get_dqrtic_nlin(; n::Int = default_nvar, kwargs...) = 0
get_dqrtic_nnln(; n::Int = default_nvar, kwargs...) = 0
get_dqrtic_nequ(; n::Int = default_nvar, kwargs...) = 0
get_dqrtic_nineq(; n::Int = default_nvar, kwargs...) = 0
