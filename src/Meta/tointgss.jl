...
get_tointgss_nvar(; n::Int = default_nvar, kwargs...) = 1 * n + 0
get_tointgss_ncon(; n::Int = default_nvar, kwargs...) = 0
get_tointgss_nlin(; n::Int = default_nvar, kwargs...) = 0
get_tointgss_nnln(; n::Int = default_nvar, kwargs...) = 0
get_tointgss_nequ(; n::Int = default_nvar, kwargs...) = 0
get_tointgss_nineq(; n::Int = default_nvar, kwargs...) = 0
