...
get_genrose_nash_nvar(; n::Int = default_nvar, kwargs...) = 1 * n + 0
get_genrose_nash_ncon(; n::Int = default_nvar, kwargs...) = 0
get_genrose_nash_nlin(; n::Int = default_nvar, kwargs...) = 0
get_genrose_nash_nnln(; n::Int = default_nvar, kwargs...) = 0
get_genrose_nash_nequ(; n::Int = default_nvar, kwargs...) = 0
get_genrose_nash_nineq(; n::Int = default_nvar, kwargs...) = 0
