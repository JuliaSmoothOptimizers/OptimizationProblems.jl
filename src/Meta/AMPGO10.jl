...
get_AMPGO10_nvar(; n::Int = default_nvar, kwargs...) = 1
get_AMPGO10_ncon(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO10_nlin(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO10_nnln(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO10_nequ(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO10_nineq(; n::Int = default_nvar, kwargs...) = 0
