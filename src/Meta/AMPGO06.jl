AMPGO06_meta = Dict(
  ...
  :best_known_upper_bound => 3.517695989514065e-43,
  :is_feasible => true,
...
get_AMPGO06_nvar(; n::Int = default_nvar, kwargs...) = 1
get_AMPGO06_ncon(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO06_nlin(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO06_nnln(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO06_nequ(; n::Int = default_nvar, kwargs...) = 0
get_AMPGO06_nineq(; n::Int = default_nvar, kwargs...) = 0
