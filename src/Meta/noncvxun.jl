...
get_noncvxun_nvar(; n::Int = default_nvar, kwargs...) = 1 * n + 0
get_noncvxun_ncon(; n::Int = default_nvar, kwargs...) = 0
get_noncvxun_nlin(; n::Int = default_nvar, kwargs...) = 0
get_noncvxun_nnln(; n::Int = default_nvar, kwargs...) = 0
get_noncvxun_nequ(; n::Int = default_nvar, kwargs...) = 0
get_noncvxun_nineq(; n::Int = default_nvar, kwargs...) = 0
