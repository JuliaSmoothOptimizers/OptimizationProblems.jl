...
get_noncvxu2_nvar(; n::Int = default_nvar, kwargs...) = 1 * n + 0
get_noncvxu2_ncon(; n::Int = default_nvar, kwargs...) = 0
get_noncvxu2_nlin(; n::Int = default_nvar, kwargs...) = 0
get_noncvxu2_nnln(; n::Int = default_nvar, kwargs...) = 0
get_noncvxu2_nequ(; n::Int = default_nvar, kwargs...) = 0
get_noncvxu2_nineq(; n::Int = default_nvar, kwargs...) = 0
