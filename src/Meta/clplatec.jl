...
get_clplatec_nvar(; n::Int = default_nvar, kwargs...) = max(floor(Int, sqrt(n)), 3)^2
get_clplatec_ncon(; n::Int = default_nvar, kwargs...) = 0
get_clplatec_nlin(; n::Int = default_nvar, kwargs...) = 0
get_clplatec_nnln(; n::Int = default_nvar, kwargs...) = 0
get_clplatec_nequ(; n::Int = default_nvar, kwargs...) = 0
get_clplatec_nineq(; n::Int = default_nvar, kwargs...) = 0
