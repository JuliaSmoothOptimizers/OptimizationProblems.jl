...
get_palmer6c_nvar(; n::Int = default_nvar, kwargs...) = 8
get_palmer6c_ncon(; n::Int = default_nvar, kwargs...) = 0
get_palmer6c_nlin(; n::Int = default_nvar, kwargs...) = 0
get_palmer6c_nnln(; n::Int = default_nvar, kwargs...) = 0
get_palmer6c_nequ(; n::Int = default_nvar, kwargs...) = 0
get_palmer6c_nineq(; n::Int = default_nvar, kwargs...) = 0
get_palmer6c_nls_nequ(; n::Int = default_nvar, kwargs...) = 13
