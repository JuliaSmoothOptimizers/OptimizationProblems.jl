...
get_lanczos2_nvar(; n::Int = default_nvar, kwargs...) = 6
get_lanczos2_ncon(; n::Int = default_nvar, kwargs...) = 0
get_lanczos2_nlin(; n::Int = default_nvar, kwargs...) = 0
get_lanczos2_nnln(; n::Int = default_nvar, kwargs...) = 0
get_lanczos2_nequ(; n::Int = default_nvar, kwargs...) = 0
get_lanczos2_nineq(; n::Int = default_nvar, kwargs...) = 0
get_lanczos2_nls_nequ(; n::Int = default_nvar, kwargs...) = 24
