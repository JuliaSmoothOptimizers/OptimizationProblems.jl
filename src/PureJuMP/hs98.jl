...
function hs98(args...; kwargs...)
  ...
  @constraint(nlp, -273 * x[2] - 70 * x[4] - 819 * x[5] + 26000 * x[4] * x[5] ≥ b[3])
  @constraint(
    nlp,
    159.9 * x[1] - 311 * x[2] + 587 * x[4] + 391 * x[5] + 2198 * x[6] - 14000 * x[1] * x[6] ≥ b[4]
  )
