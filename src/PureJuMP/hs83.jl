...
function hs83(args...; kwargs...)
  ...
  @constraint(nlp, 0 ≤ a[1] + a[2] * x[2] * x[5] + a[3] * x[1] * x[4] - a[4] * x[3] * x[5] ≤ 92)
  @constraint(
    nlp,
    0 ≤ a[5] + a[6] * x[2] * x[5] + a[7] * x[1] * x[2] - a[8] * x[3] * x[3] - 90 ≤ 20
  )
  @constraint(
    nlp,
  ...
  @objective(nlp, Min, 5.3578547 * x[3]^2 + 0.8356891 * x[1] * x[5] + 37.293239 * x[1] - 40792.141)
